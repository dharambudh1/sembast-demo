...
typedef DetailsCallback = Function(Details num);

class CreateEntry extends StatefulWidget {
  final bool editMode;
  final Details detailsValues;
  final UserRepository userRepository;
  final DetailsCallback detailsChangeCallBack;
  ...
  const CreateEntry({
    ...
    required this.detailsChangeCallBack,
  }) : super(key: key);
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              if (widget.editMode == true) {
                                widget.detailsChangeCallBack(_localObject);
                              } else {
                                widget.detailsChangeCallBack(_localObject);
                              }
